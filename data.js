/* ============================================================
   ...
   ฟิลด์ในแต่ละวัด:
     ...
     established — วันที่สร้าง/เปิดวัด รูปแบบ YYYY-MM-DD (ใช้คำนวณอายุวัด)
     history     — ข้อความประวัติความเป็นมาของวัด
     gallery     — ลิงก์รูปภาพวัด/กิจกรรม คั่นด้วยขึ้นบรรทัดใหม่
   ============================================================ */
